...
function add_location(){
    $con=mysqli_connect ("localhost", 'root', '2222','map');
    if (!$con) {
...
//fetch confirmed location from db
...
select id ,lat,lng,description,location_status,image as isconfirmed
